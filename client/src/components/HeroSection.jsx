...
const HeroSection = () => {
  ...
  return (
    ...
    bg-cover bg-center h-screen'>
     ...
     <p className='max-w-md text-gray-300'>In a post-apocalyptic world where cities ride on wheels cities ride 
      on wheels and consume each other to servive, two people meet in London
       and try to stop a conspiracy.</p>
       <button onClick={()=> navigate('/movies')} className='flex items-center gap-1 px-6 py-2 text-sm bg-primary
