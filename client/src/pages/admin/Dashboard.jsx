...
const Dashboard = () => {
  ...
  return !loading ? (
    <>
      <Title text1="Admin" text2="Dashoboard" />
      ...
      <div className='relative flex flex-wrap gap-4 mt-6'>
        ...
        px-4 py-3 bg-primary/10 border border-primary/20 rounded-md max-w-50 w-full'>
              <div>
        ...
        bg-primary/10 border border-primary/20 hover:-translate-y-1 transition duration-300'>
            ...
            <div className='flex items-center justify-between px-2'>
              ...
              <p className='flex items-center gap-1 text-sm text-gray-400 mt-1 pr-1'>
                <StarIcon className='w-4 h-4 text-primany fill-primary' />
